...
int return_index(std::vector<int> &v, int value)
{
    for (size_t i = 0; i < v.size(); i++)
    {
        ...
        {
            std::cout << blue << "returning " << i + 1 << yellow << std::endl;
            return (i + 1);
        }
    }
    return -1;
...
int main(int argc, char const *argv[])
{
    ...
    for (size_t i = 0; i < jacobsthals_indexed.size(); i++)
    {
        ...
        {// 
            ...
            // std::cout << "last size = " << last_size << std::endl;
            // std::cout << red << ">>Inserting index: " << jacobsthals_indexed[i] << std::endl;
            // std::cout << ">>Inserting " << smallest[jacobsthals_indexed[i] - 1] << yellow <<std::endl;

            // std::cout << "Searching area for upper bound" << std::endl;
            // std::cout << "calculating the upper bound for " << last_size << " in the largest sequence" << std::endl;
            // std::cout << "//&&&&&&&&&//" << std::endl;
            // print_vector(largest.begin(), largest.begin() + last_size);
            // std::cout << "//&&&&&&&&&//" << std::endl;
            ...
            // std::cout << std::endl;
            // std::cout << "Inserting " << smallest[jacobsthals_indexed[i]] << std::endl;
            // std::cout << "largest" << std::endl;
            // if (largest.size() > 0)
            // {
